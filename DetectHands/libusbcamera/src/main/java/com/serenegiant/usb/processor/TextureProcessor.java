...
public class TextureProcessor {
    ...
    public static float[] TEXTURE_COORDINATE_FLIP_HOR = {
            1.0f, 1.0f,
            0.0f, 1.0f,
            1.0f, 0.0f,
            0.0f, 0.0f,
    ...
    private float[] mTextureCoordinate = TEXTURE_COORDINATE_FLIP_HOR;
    ...
    private boolean setupTexture(int width, int height) {
        mOutTex = GLUtils.genFrameBufferTextureID(width, height);
        return mOutTex != 0;
    }
